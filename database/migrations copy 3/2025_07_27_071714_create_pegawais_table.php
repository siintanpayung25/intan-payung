...
class CreatePegawaisTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('pegawais', function (Blueprint $table) {
            ...
            $table->string('provinsi_id', 5)->nullable();
            $table->string('kabupaten_id', 7)->nullable();
            ...
            $table->string('provinsi_domisili_id', 5)->nullable();
            $table->string('kabupaten_domisili_id', 7)->nullable();
            $table->string('kecamatan_domisili_id', 10)->nullable();
            $table->string('desa_domisili_id', 13)->nullable();
            ...
            $table->string('provinsi_ktp_id', 5)->nullable();
            $table->string('kabupaten_ktp_id', 7)->nullable();
            $table->string('kecamatan_ktp_id', 10)->nullable();
            $table->string('desa_ktp_id', 13)->nullable();
            ...
            $table->foreign('satker_id')->references('satker_id')->on('satkers')->onUpdate('cascade');
