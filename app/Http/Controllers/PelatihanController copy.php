...
class PelatihanController extends BaseController
{
    public function index(Request $request)
    {
        if ($request->ajax()) {
            ...
            // Menyusun kolom yang dapat diurutkan (orderable)
            $sortableColumns = [
                'pelatihan_id',
                'nama',
                'tgl_mulai',
            ...
            // Menghitung total records dan total yang terfilter
            ...
            // Menambahkan nomor urut untuk DT_RowIndex
            ...
            foreach ($pelatihan as $item) {
                ...
                <a href="#" class="btn btn-outline-info btn-sm btn-detail" data-id="' . $item->pelatihan_id . '" data-bs-toggle="tooltip" title="Detail">
                    <i class="fas fa-eye"></i>
                </a>
                <a href="' . route('pelatihan.edit', $item->pelatihan_id) . '" class="btn btn-outline-warning btn-sm" data-bs-toggle="tooltip" title="Edit">
                    <i class="fas fa-edit"></i>
                </a>
                <button type="button" class="btn btn-outline-danger btn-sm btn-delete" data-id="' . $item->pelatihan_id . '" data-bs-toggle="tooltip" title="Hapus">
            ...
            return response()->json([
                ...
                'recordsFiltered' => $totalFiltered, // Data setelah pencarian
                'data' => $pelatihan
            ]);
        }
